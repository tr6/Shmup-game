...
# set up images
playerImage = pygame.image.load('graphics/playership.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('graphics/baddieship.png')
kamikazeImage = pygame.image.load('graphics/baddieship2.png')
rapidBulletImage = pygame.image.load('graphics/bulletplaceholder.png')
explosionImage = pygame.image.load('graphics/explosion.png')
baddieBulletImage = pygame.image.load('graphics/baddiebullet.png')

# show the "Start" screen
windowSurface.blit(pygame.transform.scale(baddieImage, (200, 200)), pygame.Rect(((WINDOWWIDTH / 2) - 100), 30, 200, 200))
drawText('Shoot \'em up', font, windowSurface, (WINDOWWIDTH / 3 - 25), 50)
drawText('Controls', font, windowSurface, (WINDOWWIDTH / 3 - 25), (WINDOWHEIGHT / 3 + 70))
drawText('W A S D - Move', font, windowSurface, (WINDOWWIDTH / 3 - 25), (WINDOWHEIGHT / 3 + 120))
drawText('Spacebar - Shoot', font, windowSurface, (WINDOWWIDTH / 3 - 25), (WINDOWHEIGHT / 3 + 170))
